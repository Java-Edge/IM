...
import com.javaedge.im.service.group.model.req.SendGroupMessageReq;
import com.javaedge.im.service.message.model.resp.SendMessageResp;
import com.javaedge.im.service.message.service.CheckSendMessageService;
import com.javaedge.im.service.message.service.MessageStoreService;
...
public class GroupMessageService {
    ...
    private void dispatchMessage(GroupChatMessageContent messageContent){
        for (String memberId : messageContent.getMemberId()) {
            if(!memberId.equals(messageContent.getFromId())){
                msgProducer.send2User(memberId,
    ...
    private void ack(MessageContent messageContent,ResponseVO responseVO){
        ...
        //發消息
        msgProducer.send2User(messageContent.getFromId(),
