...
import com.javaedge.im.codec.pack.user.UserModifyPack;
...
import com.javaedge.im.service.user.dao.mapper.ImUserDataMapper;
import com.javaedge.im.service.user.model.req.*;
import com.javaedge.im.service.user.model.resp.GetUserInfoResp;
import com.javaedge.im.service.user.model.resp.ImportUserResp;
...
public class ImUserviceImpl implements ImUserService {
    ...
    public ResponseVO modifyUserInfo(ModifyUserInfoReq req) {
        ...
        if (update1 == 1) {
            ...
            msgProducer.send2User(req.getUserId(), req.getClientType(), req.getImei(),
