package com.javaedge.im.service.user.controller;
...
import com.javaedge.im.common.utils.RouteInfoParseUtil;
...
import com.javaedge.im.service.utils.ZKit;
...
public class ImUserController {
    ...
    public ResponseVO login(@RequestBody @Validated LoginReq req, Integer appId) {
        ...
        if (login.isOk()) {
            ...
            // ip:port
            String serverInfo = routeHandle.routeServer(nodes, req.getUserId());
            RouteInfo parse = RouteInfoParseUtil.parse(serverInfo);
