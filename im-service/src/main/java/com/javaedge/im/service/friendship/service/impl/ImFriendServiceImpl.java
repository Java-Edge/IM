...
import com.javaedge.im.codec.pack.friendship.*;
...
import com.javaedge.im.common.enums.AllowFriendTypeEnum;
import com.javaedge.im.common.enums.CheckFriendShipTypeEnum;
import com.javaedge.im.common.enums.FriendShipErrorCode;
import com.javaedge.im.common.enums.FriendShipStatusEnum;
...
import com.javaedge.im.service.friendship.dao.ImFriendShipEntity;
import com.javaedge.im.service.friendship.dao.mapper.ImFriendShipMapper;
import com.javaedge.im.service.friendship.model.callback.AddFriendAfterCallbackDto;
import com.javaedge.im.service.friendship.model.callback.AddFriendBlackAfterCallbackDto;
import com.javaedge.im.service.friendship.model.callback.DeleteFriendAfterCallbackDto;
import com.javaedge.im.service.friendship.model.req.*;
import com.javaedge.im.service.friendship.model.resp.CheckFriendShipResp;
import com.javaedge.im.service.friendship.model.resp.ImportFriendShipResp;
...
import com.javaedge.im.service.user.service.ImUserService;
import com.javaedge.im.service.utils.CallbackService;
...
public class ImFriendServiceImpl implements ImFriendService {
    ...
    public ResponseVO updateFriend(UpdateFriendReq req) {
        ...
        if (responseVO.isOk()) {
            ...
            msgProducer.send2User(req.getFromId(),
...
//            toItem.setBlack(FriendShipStatusEnum.BLACK_STATUS_NORMAL.getCode());
        ...
        msgProducer.send2User(toItem.getFromId(),
    ...
    public ResponseVO deleteAllFriend(DeleteFriendReq req) {
        ...
        deleteFriendPack.setFromId(req.getFromId());
        msgProducer.send2User(req.getFromId(), req.getClientType(), req.getImei(), FriendshipEventCommand.FRIEND_ALL_DELETE,
                deleteFriendPack, req.getAppId());
    ...
    public ResponseVO addBlack(AddFriendShipBlackReq req) {
        ...
        //发送tcp通知
        msgProducer.send2User(req.getFromId(), req.getClientType(), req.getImei(),
    ...
    public ResponseVO deleteBlack(DeleteBlackReq req) {
        ...
        if (update1 == 1) {
            ...
            deleteFriendPack.setSequence(seq);
            deleteFriendPack.setToId(req.getToId());
            msgProducer.send2User(req.getFromId(), req.getClientType(), req.getImei(), FriendshipEventCommand.FRIEND_BLACK_DELETE,
                    deleteFriendPack, req.getAppId());
